...
import useInitial from 'react-photo-view/dist/hooks/useInitial';
import useMethods from 'react-photo-view/dist/hooks/useMethods';
import PhotoContext from 'react-photo-view/dist/photo-context';
import type {PhotoContextType} from 'react-photo-view/dist/photo-context.d.ts';
import type {PhotoRenderParams} from 'react-photo-view/dist/types.d.ts';
...
const TS: React.FC<PhotoViewProps> = ({
  src,
  render,
  overlay,
  width,
